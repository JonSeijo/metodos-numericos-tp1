...
\todo[inline]{Ver lo de definida positiva}
...
Como nuestra matriz $A$ es simétrica y definida positiva  una gran opción es utilizar la factorización de cholesky para reducir los cálculos, ya que tiene constantes mas baja que la eliminación gaussiana. Ademas, como nuestras matrices ya no son vectores no es \textit{nada} trivial la implementacion de la eliminacion gaussiana para estas nuevas matrices. Sin embargo, sumar y multiplicar elementos es algo que sabemos hacer muy bien.
