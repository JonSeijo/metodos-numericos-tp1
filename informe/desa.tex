...
$ $ \hspace{30pt} $= -2 n_{1,2}^4 n_{1,2}^2 + (n_{1,2}^2 + 2 n_{1,3}^2) . n_{1,1}^4 + 4 n_{1,1}^2 n_{1,2}^2$

$ $ \hspace{30pt} $= -2 n_{1,2}^4 n_{1,2}^2 + n_{1,1}^4 n_{1,2}^2 + 4 n_{1,2}^4 n_{1,2}^2 + 2 n_{1,3}^2 n_{1,1}^2 + 8 n_{1,1}^2 n_{1,2}^2 n_{1,3}^2$

$ $ \hspace{30pt} $= n_{1,1}^4 n_{1,2}^2 + 2 n_{1,2}^4 n_{1,2}^2 + 2 n_{1,3}^2 n_{1,1}^2 + 8 n_{1,1}^2 n_{1,2}^2 n_{1,3}^2$
