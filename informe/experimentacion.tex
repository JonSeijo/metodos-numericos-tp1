...
\begin{minipage}{.5\textwidth}
  ...
  \captionof{figure}{Luces 0,5,8 - Componente Azul}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
    \includegraphics[width=1\linewidth]{informe/imagenes/profundidades/caballo058Rojo.png}
    \captionof{figure}{Luces 0,5,8 - Componente Roja}
\end{minipage}
\end{figure}
...
\newpage
Nos planteamos entonces un último experimento. Queremos ver qué sucede cuando tomamos las 3 luces de frente, en las cuales se verá una baja cantidad de sombras. Elegimos entonces las luces 1, 2 y 10. Por lo observado anteriormente, esperamos obtener muy malos resultados. \\
...
{\centering
    ...
    \captionof{figure}{Comparación logarítmica de tiempo acumulado en la resolución de sistemas.}
}

$ $\newline
Podemos observar en el gráfico que se cumple lo esperado, Gauss es por lejos el más lento de los métodos. Retriangular la matriz cada vez hace que tenga orden cúbico, mientras que con LU y Cholesky al tener la factorización sólo debemos realizar despejes. Algo quizá no contemplado es la pequeña diferencia de tiempos entre LU y Cholesky, que sospechamos fuertemente que está relacionada con la forma en que los implementamos. \\
