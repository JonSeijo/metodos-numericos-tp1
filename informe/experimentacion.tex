...
\todo[inline]{Al menos dos imagenes normales de profundidad, con sets diferentes}
...
\todo[inline]{Profundidades de gato mismo set de luces, diferentes tomas de colores}

\todo[inline]{QUIZA, Profundidades de gato con otro set de luces, diferentes tomas de colores, para descartar que sea cosa de este set en particular}





Es interesante notar que utilizando diferentes combinaciones de luces obtuvimos diferentes resultados.
\todo[inline]{hablar de diferencias vistas en los sets} Siguen sin verse correctamente los detalles en el rostro del caballo. En el siguiente experimento intentaremos ver cómo la elección de luces repercute en las profundidades finales. Para ello, realizamos los cálculos de profundidad con una imagen que tiene más detalles. \\
...
\todo[inline]{Imagenes de buda fijando dos luces y haciendo variar las demás}

\todo[inline]{Conclusiones sobre los detalles y las cosas de buda}
